...
Organizzate le cartelle esattamente così:
...
/semeval_task8
│
├── /data                # Dove mettere i JSON di mtRAG
├── /chroma_db           # Dove il Vector Store salverà i dati
├── /src
│   ├── __init__.py
│   ├── ingestion.py     # Codice Membro 2
│   ├── retrieval.py     # Codice Membro 3
│   ├── generation.py    # Codice Membro 4 (LLAMA 3.1)
│   ├── graph.py         # Codice Membro 1 (Orchestratore)
│   └── state.py         # Definizione dello Stato Condiviso
├── /eval                # Codice Membro 5
│   └── evaluate.py
